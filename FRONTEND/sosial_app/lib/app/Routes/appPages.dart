...
import 'package:sosial_app/app/bindings/LoginBindings.dart';
import 'package:sosial_app/app/bindings/RegisterBinding.dart';
...
class Apppages {
  static final routes = [
    ...
    GetPage(name: Routes.routes.HOME, page: () => Home(), binding: HomeBindings()),
